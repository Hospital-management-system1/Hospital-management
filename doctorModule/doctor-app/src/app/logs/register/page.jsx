...
//             <button
//               type="submit"
//               className="w-full px-4 py-2 font-semibold text-white bg-info rounded-md hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500"
//             >
//               Sign up
//             </button>
//            <Link
//            href={"./login"}
//            className="mx-1 mt-4 text-sm link link-primary"
//            >
